...
public class TSmmParser extends Parser {
	...
	public final Main_function_definitionContext main_function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 171638167461896L) != 0)) {
				{
				{
				setState(54);
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public Token OP;
		public ExpressionContext salida_true;
		public ExpressionContext salida_false;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						match(T__27);
						setState(136);
						((ExpressionContext)_localctx).salida_true = ((ExpressionContext)_localctx).expression = expression(0);
						setState(137);
						match(T__4);
						setState(138);
						((ExpressionContext)_localctx).salida_false = ((ExpressionContext)_localctx).expression = expression(1);

						                          ((ExpressionContext)_localctx).ast =  new OperadorTernario(
						                              ((ExpressionContext)_localctx).condicion.ast.getLinea(),
						                              ((ExpressionContext)_localctx).condicion.ast.getColumna(),
						                              ((ExpressionContext)_localctx).condicion.ast,
						                              ((ExpressionContext)_localctx).salida_true.ast,
						                              ((ExpressionContext)_localctx).salida_false.ast
						                          );
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(156);
				((StatementContext)_localctx).START = match(T__28);
				setState(163);
				_errHandler.sync(this);
