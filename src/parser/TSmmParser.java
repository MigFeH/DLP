...
public class TSmmParser extends Parser {
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public boolean arithEquals = false;
		public Token START;
		public ExpressionContext e1;
		public ExpressionContext e2;
		public Token OP;
			...
			case 3:
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 499712L) != 0)) {
					...
					if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 499712L) != 0)) ) {
					 ...
					 ((StatementContext)_localctx).arithEquals =  true; 
					}
				}
				...
				match(T__28);
				                ...
				                if(_localctx.arithEquals) {
				                    Aritmetico arith = new Aritmetico(
				                        ((StatementContext)_localctx).e2.ast.getLinea(),
				                        ((StatementContext)_localctx).e2.ast.getColumna(),
				                    ...
				                    ((StatementContext)_localctx).e2.ast = arith;
				                }
