...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, WHITE_SPACES=42, INT_CONSTANT=43, REAL_CONSTANT=44, 
		CHAR_CONSTANT=45, COMENTARIO_UNILINEA=46, COMENTARIO_MULTILINEA=47, ID=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "WHITE_SPACES", "INT_CONSTANT", "REAL_CONSTANT", 
	...
	public final Main_function_definitionContext main_function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 343276334899208L) != 0)) {
				{
				{
				setState(54);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 343047627890696L) != 0)) {
					{
					setState(97);
					((ExpressionContext)_localctx).e1 = ((ExpressionContext)_localctx).expression = expression(0);
					...
					case 7:
						...
						if ( !(_la==T__27 || _la==T__28) ) {
							...
							consume();
						                          ...
						                          ((ExpressionContext)_localctx).ast =  new Sufijo(
						                              ((ExpressionContext)_localctx).expression.ast.getLinea(),
						                              ((ExpressionContext)_localctx).expression.ast.getColumna(),
						                              ((ExpressionContext)_localctx).expression.ast,
						                              (((ExpressionContext)_localctx).OP!=null?((ExpressionContext)_localctx).OP.getText():null).substring(0, 1)
						                          );
		...
		try {
			...
			case 8:
				...
				match(T__30);
				                ...
				                ((StatementContext)_localctx).ast =  new Sufijo(
				                    ((StatementContext)_localctx).expression.ast.getLinea(),
				                    ((StatementContext)_localctx).expression.ast.getColumna(),
				                    ((StatementContext)_localctx).expression.ast,
				                    (((StatementContext)_localctx).OP!=null?((StatementContext)_localctx).OP.getText():null).substring(0, 1)
				                );
