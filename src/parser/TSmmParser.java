...
public class TSmmParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'['", "']'", "'.'", "'as'", "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", 
			"'>'", "'>='", "'<'", "'<='", "'!='", "'=='", "'&&'", "'||'", "','", 
			"'log'", "';'", "'input'", "'='", "'if'", "'else'", "'while'", "'for'", 
			"'in'", "'return'", "'int'", "'number'", "'char'", "'let'"
		};
	}
	...
	public final Main_function_definitionContext main_function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 343242243596296L) != 0)) {
				{
				{
				setState(54);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public ExpressionContext iterador;
		public ExpressionContext datos;
		public ExpressionContext expression;
		public Token ID;
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				match(T__2);
				setState(205);
				((StatementContext)_localctx).iterador = expression(0);
				setState(206);
				match(T__35);
				setState(207);
				((StatementContext)_localctx).datos = expression(0);
				setState(208);
				match(T__3);
				setState(209);
				((StatementContext)_localctx).cuerpo = cuerpo_condicional();

				                ((StatementContext)_localctx).ast =  new ForEach(
				                    ((StatementContext)_localctx).START.getLine(),
				                    ((StatementContext)_localctx).START.getCharPositionInLine() + 1,
				                    ((StatementContext)_localctx).iterador.ast,
				                    ((StatementContext)_localctx).datos.ast,
				                    ((StatementContext)_localctx).cuerpo.ast
				                );
