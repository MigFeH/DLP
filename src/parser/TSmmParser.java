...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_tipo = 6, RULE_definition = 7, RULE_var_definition = 8, RULE_function_definition = 9, 
		RULE_function_type = 10, RULE_function_param = 11, RULE_function_return_type = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "main_function_definition", "expression", "statement", "cuerpo_condicional", 
			"tipo_simple", "tipo", "definition", "var_definition", "function_definition", 
			"function_type", "function_param", "function_return_type"
		};
	}
	...
	public final Function_typeContext function_type() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_function_type);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Function_paramContext function_param() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_function_param);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(336);
	...
	public final Function_return_typeContext function_return_type() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_function_return_type);
		try {
			setState(346);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
