...
public class SymbolTableTest {
	...
	public void testInsert() {
		...
		DefinicionVar definition = new DefinicionVar(0, 0, "a", null);
		assert st.insert(definition);
		assert definition.getScope()==0;
		assert !st.insert(definition);
		st.set();
		DefinicionVar definition2 = new DefinicionVar(0, 0, "a", null);
	...
	public void testFind() {
		SymbolTable st = new SymbolTable();
		DefinicionVar varDefinition = new DefinicionVar(0, 0, "a", null);
		assert st.insert(varDefinition);
		assert st.find("a")!=null;
		assert st.find("b")==null;
		st.set();
		DefinicionVar varDefinition2 = new DefinicionVar(0, 0, "b", null);
		...
		assert st.find("c")==null;
		DefinicionVar varDefinition3 = new DefinicionVar(0, 0, "c", null);
		assert st.insert(varDefinition3);
		assert st.find("c")!=null;
		st.set();
		DefinicionVar varDefinition4 = new DefinicionVar(0, 0, "d", null);
